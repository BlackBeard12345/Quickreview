<?php $__env->startSection('content'); ?>
        ...
        <table class="all-films-table">
            ...
            <?php $__currentLoopData = $film->reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('user.reviews.show', $review->id)); ?>">Zobacz</a>
                    <?php if(Auth::id() == $review->user->id): ?>
                            |<a href="<?php echo e(route('user.reviews.edit', $film->id)); ?>">Edytuj</a> | <a href="<?php echo e(route('user.reviews.delete', $film->id)); ?>">Usuń</a>
                        <?php endif; ?>
                    </td>
                </tr>
    ...
    <form class="form" method="POST" action="<?php echo e(route('user.reviews.store', $film->id)); ?>">
        <?php echo csrf_field(); ?>
        <p>Dodaj recenzję</p>
        <?php if($errors->any()): ?>
            <p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Programy\xampp\htdocs\QuickReview-test\resources\views/user/films/show.blade.php ENDPATH**/ ?>